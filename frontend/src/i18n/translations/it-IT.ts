export default {
  ...
  "home.bullet.a.description": "Configura GYTECH Cloud sul tuo server.",
  ...
  "admin.config.config-file-warning.description": "Poiché hai configurato GYTECH Cloud tramite un file di configurazione, non ti è possibile modificare la configurazione dall'interfaccia utente.",
  ...
  "admin.config.general.app-url.description": "Su quale URL GYTECH Cloud è pubblicato",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente GYTECH Cloud mantiene la cache in memoria. Se si eseguono più istanze di GYTECH Cloud, è necessario abilitare il caching di Redis per condividere la cache tra le istanze.",
