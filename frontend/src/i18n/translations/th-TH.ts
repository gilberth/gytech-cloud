export default {
  ...
  "home.bullet.a.description": "โฮสต์ GYTECH Cloud บนเครื่องของคุณเอง.",
  ...
  "admin.config.general.app-url.description": "URL ที่สามารถเข้าถึงแอพพลิเคชัน GYTECH Cloud ได้",
