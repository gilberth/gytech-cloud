export default {
  ...
  "home.bullet.a.description": "A GYTECH Cloud megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A GYTECH Cloud megosztáskezelőre mutató hivatkozás",
