export default {
  ...
  "home.bullet.a.description": "Hosta GYTECH Cloud på din egen maskin.",
  ...
  "admin.config.config-file-warning.description": "Eftersom du har en konfigurerad GYTECH Cloud med en konfigurationsfil kan du inte ändra konfigurationen genom UI.",
  ...
  "admin.config.general.app-url.description": "På vilken URL GYTECH Cloud finns",
