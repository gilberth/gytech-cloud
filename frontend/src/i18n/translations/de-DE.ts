export default {
  ...
  "home.bullet.a.description": "Betreibe GYTECH Cloud auf deinem eigenen Server.",
  ...
  "admin.config.config-file-warning.description": "Da GYTECH Cloud mit einer Konfigurationsdatei konfiguriert ist, kann die Konfiguration nicht über die Benutzeroberfläche geändert werden.",
  ...
  "admin.config.general.app-url.description": "Auf welcher URL GYTECH Cloud verfügbar ist",
