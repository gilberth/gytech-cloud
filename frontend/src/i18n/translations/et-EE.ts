export default {
  ...
  "home.bullet.a.description": "Hosti GYTECH Cloud oma seadmes.",
  ...
  "admin.config.config-file-warning.description": "Kuna teil on konfigureeritud GYTECH Cloud konfiguratsioonifailiga, ei saa te muuta konfiguratsiooni kasutajaliidest kasutades.",
  ...
  "admin.config.general.app-url.description": "URL, mille kaudu GYTECH Cloud on kättesaadav",
