export default {
  ...
  "home.bullet.a.description": "Hostujte GYTECH Cloud na svém vlastním počítači.",
  ...
  "admin.config.config-file-warning.description": "Jelikož je GYTECH Cloud nastaven pomocí konfiguračního souboru, nemůžete změnit nastavení přes UI.",
  ...
  "admin.config.general.app-url.description": "Na kterém URL je GYTECH Cloud k dispozici",
