export default {
  ...
  "home.bullet.a.description": "Hostujte GYTECH Cloud na svojoj mašini.",
  ...
  "admin.config.config-file-warning.description": "Pošto ste konfigurisali GYTECH Cloud pomoću konfiguracionog fajla, ne možete menjati konfiguraciju putem korisničkog interfejsa (UI).",
  ...
  "admin.config.general.app-url.description": "Na kojoj URL adresi je dostupan GYTECH Cloud",
  ...
  "admin.config.cache.redis-enabled.description": "GYTECH Cloud obično kešira informacije u memoriji. Ako pokrećete više instanci GYTECH Cloud-a, potrebno je da omogućite Redis keširanje kako bi se keš delio između instanci.",
