export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το GYTECH Cloud στο δικό σας μηχάνημα.",
  ...
  "admin.config.config-file-warning.description": "As you have a configured GYTECH Cloud with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το GYTECH Cloud είναι διαθέσιμο",
