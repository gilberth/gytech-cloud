export default {
  ...
  "home.bullet.a.description": "GYTECH Cloud працює на вашій машині.",
  ...
  "admin.config.config-file-warning.description": "Оскільки у вас налаштовано GYTECH Cloud за допомогою конфігураційного файлу, ви не можете змінювати конфігурацію через інтерфейс користувача.",
  ...
  "admin.config.general.app-url.description": "Адреса, на якій доступний GYTECH Cloud",
