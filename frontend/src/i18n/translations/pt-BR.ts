export default {
  ...
  "home.bullet.a.description": "Hospede o GYTECH Cloud em sua própria máquina.",
  ...
  "admin.config.config-file-warning.description": "Como você tem um GYTECH Cloud configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  ...
  "admin.config.general.app-url.description": "Em qual URL o GYTECH Cloud está disponível",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente informações de caches GYTECH Cloud na memória. Se você executar várias instâncias do GYTECH Cloud, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
