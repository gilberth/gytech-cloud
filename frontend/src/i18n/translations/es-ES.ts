export default {
  ...
  "home.bullet.a.description": "Aloja GYTECH Cloud en tu propio equipo.",
  ...
  "account.shares.table.more-files": "más",
  "account.shares.table.thumbnail": "Miniatura",
  "account.shares.table.status": "Estado",
  "account.shares.search.placeholder": "Buscar archivos compartidos...",
  "account.shares.status.expired": "Expirado",
  "account.shares.status.expiring": "Expira pronto",
  "account.shares.status.view-limit": "Límite alcanzado",
  "account.shares.status.active": "Activo",
  "account.shares.search.no-results": "No se encontraron archivos compartidos que coincidan con tu búsqueda",
  "account.shares.search.try-different": "Intenta con otros términos de búsqueda",
  "account.shares.bulk.select-all": "Seleccionar todo",
  "account.shares.bulk.deselect-all": "Deseleccionar todo",
  "account.shares.bulk.delete-selected": "Eliminar seleccionados",
  "account.shares.bulk.selected-count": "{count} seleccionado(s)",
  "account.shares.bulk.confirm-delete.title": "Eliminar {count} archivo(s) compartido(s)",
  "account.shares.bulk.confirm-delete.description": "¿Estás seguro de que quieres eliminar los {count} archivos compartidos seleccionados?",
  ...
  "admin.config.config-file-warning.description": "Como tienes configurado GYTECH Cloud con un archivo de configuración, no puedes cambiar la configuración a través de la interfaz gráfica.",
  "admin.config.title": "Configuración",
  "admin.config.storage.title": "Gestión de Almacenamiento",
  "admin.migration.title": "Migración de Almacenamiento",
  ...
  "admin.config.general.app-url.description": "En cuál URL está disponible GYTECH Cloud",
  ...
  "admin.config.cache.redis-enabled.description": "Normally GYTECH Cloud caches information in memory. If you run multiple instances of GYTECH Cloud, you need to enable Redis caching to share the cache between the instances.",
  ...
  "admin.config.onedrive.enabled": "Habilitado",
  "admin.config.onedrive.enabled.description": "Si se debería utilizar OneDrive para almacenar los archivos compartidos.",
  "admin.config.onedrive.client-id": "Client ID",
  "admin.config.onedrive.client-id.description": "El Client ID de su aplicación de Microsoft Azure.",
  "admin.config.onedrive.client-secret": "Client Secret",
  "admin.config.onedrive.client-secret.description": "El Client Secret de su aplicación de Microsoft Azure.",
  "admin.config.onedrive.tenant-id": "Tenant ID",
  "admin.config.onedrive.tenant-id.description": "El Tenant ID de su directorio de Microsoft Azure.",
  "admin.config.onedrive.drive-id": "Drive ID",
  "admin.config.onedrive.drive-id.description": "El ID del OneDrive donde se deben almacenar los archivos.",

  "admin.config.googledrive.enabled": "Habilitado",
  "admin.config.googledrive.enabled.description": "Si se debería utilizar Google Drive para almacenar los archivos compartidos.",
  "admin.config.googledrive.client-id": "Client ID",
  "admin.config.googledrive.client-id.description": "El Client ID de su proyecto de Google Cloud.",
  "admin.config.googledrive.client-secret": "Client Secret",
  "admin.config.googledrive.client-secret.description": "El Client Secret de su proyecto de Google Cloud.",
  "admin.config.googledrive.refresh-token": "Refresh Token",
  "admin.config.googledrive.refresh-token.description": "El token de actualización para acceder a la API de Google Drive.",
  "admin.config.googledrive.parent-folder-id": "ID de Carpeta Principal",
  "admin.config.googledrive.parent-folder-id.description": "El ID de la carpeta de Google Drive donde se deben almacenar los archivos.",

  "admin.config.azureblob.enabled": "Habilitado",
  "admin.config.azureblob.enabled.description": "Si se debería utilizar Azure Blob Storage para almacenar los archivos compartidos.",
  "admin.config.azureblob.account-name": "Nombre de Cuenta",
  "admin.config.azureblob.account-name.description": "El nombre de su cuenta de Azure Storage.",
  "admin.config.azureblob.account-key": "Clave de Cuenta",
  "admin.config.azureblob.account-key.description": "La clave de acceso para su cuenta de Azure Storage.",
  "admin.config.azureblob.sas-token": "Token SAS",
  "admin.config.azureblob.sas-token.description": "El token de Firma de Acceso Compartido (alternativa a la clave de cuenta).",
  "admin.config.azureblob.container-name": "Nombre de Contenedor",
  "admin.config.azureblob.container-name.description": "El nombre del contenedor de Azure Blob donde se deben almacenar los archivos.",
