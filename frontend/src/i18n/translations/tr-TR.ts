export default {
  ...
  "home.bullet.a.description": "GYTECH Cloud'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.config-file-warning.description": "GYTECH Cloud'i bir yapılandırma dosyası ile kurduğunuz için, yapılandırmayı arayüz üzerinden değiştiremezsiniz.",
  ...
  "admin.config.general.app-url.description": "GYTECH Cloud'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde GYTECH Cloud bilgileri bellekte önbellekler. Birden fazla GYTECH Cloud örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
