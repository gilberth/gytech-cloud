export default {
  ...
  "home.bullet.a.description": "GYTECH Cloudをあなたのマシンでホストしましょう。",
  ...
  "admin.config.config-file-warning.description": "設定ファイル設定で済みのGYTECH CloudはUI を使用して設定を変更することはできません。",
  ...
  "admin.config.general.app-url.description": "GYTECH Cloudで利用できるURL",
  ...
  "admin.config.cache.redis-enabled.description": "通常、GYTECH Cloud は情報をメモリ内にキャッシュします。複数の GYTECH Cloud インスタンスを実行する場合は、インスタンス間でキャッシュを共有するために Redis キャッシュを有効にする必要があります。",
