export default {
  ...
  "home.bullet.a.description": "Isännöi \"GYTECH Cloud\" omalla palvelimellasi.",
  ...
  "admin.config.general.app-url.description": "Millä URL-osoitteella GYTECH Cloud on saatavilla",
