export default {
  ...
  "home.bullet.a.description": "Gostuj GYTECH Cloud na svoji lastni napravi.",
  ...
  "admin.config.general.app-url.description": "Na katerem URL-ju je dostopen GYTECH Cloud",
