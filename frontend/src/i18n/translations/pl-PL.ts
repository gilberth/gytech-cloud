export default {
  ...
  "home.bullet.a.description": "Utrzymuj GYTECH Cloud na własnym serwerze.",
  ...
  "admin.config.general.app-url.description": "Pod którym adresem URL GYTECH Cloud jest dostępny",
