export default {
  ...
  "home.bullet.a.description": "Hébergez GYTECH Cloud sur votre propre machine.",
  ...
  "admin.config.config-file-warning.description": "Puisque vous avez configuré GYTECH Cloud avec un fichier de configuration, vous ne pouvez pas modifier la configuration via l'interface utilisateur.",
  ...
  "admin.config.general.app-url.description": "Depuis quel URL le partage GYTECH est disponible",
  ...
  "admin.config.cache.redis-enabled.description": "Usuellement, GYTECH Cloud conserve les informations en mémoire vive. Si vous exécutez plusieurs instances de GYTECH Cloud, vous devez activer la mise en cache Redis pour partager le cache entre ces instances.",
