export default {
  ...
  "home.bullet.a.description": "Host GYTECH Cloud on your own machine.",
  ...
  "admin.config.general.app-url.description":
    "On which URL GYTECH Cloud is available",
  ...
  "admin.config.cache.redis-enabled.description":
    "Normally GYTECH Cloud caches information in memory. If you run multiple instances of GYTECH Cloud, you need to enable Redis caching to share the cache between the instances.",
